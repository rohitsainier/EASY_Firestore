...
class CustomTabBarController: UITabBarController,CustomTabBarViewDelegate{
    ...
    func addTabBarView()
    {
        ...
        self.view.addConstraint(NSLayoutConstraint(item: self.tabBarView, attribute: NSLayoutConstraint.Attribute.height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1.0, constant: 50.0))
